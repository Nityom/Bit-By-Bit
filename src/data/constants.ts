...
export const EXPERIENCE: Experience[] = [
  {
    ...
    startDate: "Jan 2023",
    endDate: "Present",
    title: "Freelance Development Agency",
    company: "Bit By Bit Studio",
    description: [
      "Built custom web applications and mobile apps for diverse clients across industries.",
      "Delivered 20+ successful projects including e-commerce platforms, booking systems, and SaaS solutions.",
      "Specialized in modern tech stack: React, Next.js, Node.js, and cloud deployments.",
      "Managed full project lifecycle from requirements gathering to production deployment.",
      "Maintained 98% client satisfaction rate with focus on quality and timely delivery.",
    ],
    skills: [
      SkillNames.REACT,
      SkillNames.NEXTJS,
  ...
  },
  {
    ...
    company: "Bit By Bit Studio",
    description: [
      "Established freelance development practice focused on small to medium business clients.",
      "Created responsive websites and custom web applications using modern frameworks.",
      "Provided consultation on digital transformation and technology solutions.",
      "Implemented SEO best practices and performance optimization for all projects.",
    ],
    skills: [
      SkillNames.HTML,
      SkillNames.CSS,
