...
const projects: Project[] = [
  {
    ...
    title: "Titanium Smiles",
    src: "/assets/projects-screenshots/Titanium/landing.png",
    ...
    live: "https://titaniumsmiles.in/",
    get content() {
      return (
        <div>
          <TypographyP className="font-mono text-2xl text-center">
            Modern Patient Management System for Dental Care
          </TypographyP>
          <TypographyP className="font-mono">
            Titanium Smiles is a comprehensive patient management system designed
            for dental clinics. It streamlines appointment scheduling, patient
            records, treatment plans, and billing processes.
          </TypographyP>
          <ProjectsLinks live={this.live} />
          <TypographyH3 className="my-4 mt-8">Key Features</TypographyH3>
          <ul className="list-disc ml-6">
            <li className="font-mono">Appointment scheduling and management</li>
            <li className="font-mono">Digital patient records and history</li>
            <li className="font-mono">Treatment planning and tracking</li>
            <li className="font-mono">Billing and payment processing</li>
          </ul>
        </div>
      );
    },
  },
  {
    ...
    title: "Cortex Hospital",
    src: "/assets/projects-screenshots/the-booking-desk/landing.png",
    screenshots: ["landing.png"],
    live: "https://www.cortexhospital.com/",
    skills: {
      frontend: [
        PROJECT_SKILLS.react,
        PROJECT_SKILLS.next,
    ...
    get content() {
      return (
        <div>
          <TypographyP className="font-mono text-2xl text-center">
            Professional Hospital Website with Advanced Features
          </TypographyP>
          <TypographyP className="font-mono">
            Cortex Hospital&apos;s website provides comprehensive information about
            medical services, departments, and healthcare professionals. Features
            online appointment booking and patient resources.
          </TypographyP>
          <ProjectsLinks live={this.live} />
          <TypographyH3 className="my-4 mt-8">Features</TypographyH3>
          <ul className="list-disc ml-6">
            <li className="font-mono">Department and service information</li>
            <li className="font-mono">Doctor profiles and specializations</li>
            <li className="font-mono">Online appointment booking</li>
            <li className="font-mono">Patient resources and health tips</li>
          </ul>
        </div>
      );
    },
  },
  {
    ...
    title: "DantSri Hospital",
    src: "/assets/projects-screenshots/ghostchat/1.png",
    screenshots: ["1.png"],
    live: "https://dantsri.com/",
    skills: {
      frontend: [
        PROJECT_SKILLS.react,
        PROJECT_SKILLS.next,
    ...
    get content() {
      return (
        <div>
          ...
          <TypographyP className="font-mono">
            DantSri Hospital&apos;s website showcases dental services with a modern,
            user-friendly interface. Includes service details, team information,
            and contact features.
          </TypographyP>
          <ProjectsLinks live={this.live} />
          <TypographyH3 className="my-4 mt-8">Highlights</TypographyH3>
          <ul className="list-disc ml-6">
            <li className="font-mono">Responsive design with smooth animations</li>
            <li className="font-mono">Service showcase with detailed information</li>
            <li className="font-mono">Team introduction and expertise</li>
            <li className="font-mono">Contact and location information</li>
          </ul>
        </div>
      );
    },
  ...
  {
    id: "shishirconsultants",
    category: "Interior Design",
    title: "Shishir Consultants",
    src: "/assets/projects-screenshots/portfolio/nav.png",
    screenshots: ["nav.png"],
    live: "https://shishirconsultants.in/",
    skills: {
      frontend: [
        PROJECT_SKILLS.react,
        PROJECT_SKILLS.next,
    ...
    get content() {
      return (
        <div>
          <TypographyP className="font-mono text-2xl text-center">
            Professional Interior Design & Consulting Services
          </TypographyP>
          <TypographyP className="font-mono">
            Shishir Consultants specializes in creating beautiful and functional
            interior spaces. The website showcases their design portfolio,
            services, and interior solutions.
          </TypographyP>
          <ProjectsLinks live={this.live} />
          <TypographyH3 className="my-4 mt-8">Services</TypographyH3>
          <ul className="list-disc ml-6">
            <li className="font-mono">Residential interior design</li>
            <li className="font-mono">Commercial space planning</li>
            <li className="font-mono">3D visualization and rendering</li>
            <li className="font-mono">Custom furniture and decor solutions</li>
          </ul>
        </div>
      );
    },
  ...
  // {
  //   id: "codingducks",
  //   category: "Patient Manaagement System",
  //   title: "Titanium Smiles",
